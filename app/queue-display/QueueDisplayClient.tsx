...
// لو المتغيرات دي مش متظبطة صح في Vercel، مبقاش نكسر الصفحة كلها —
// بنسيب supabase = null وبنعرض رسالة واضحة بدل الشاشة البيضاء
const supabase =
...
export default function QueueDisplayClient() {
  ...
  useEffect(() => {
    ...
    // تحديث تلقائي احتياطي كل 5 دقايق - مجرد شبكة أمان لو الاتصال اللحظي (Realtime)
